...
async function setupViewer(){
    ...
    viewer.setBackground(new Color('#dadbff').convertSRGBToLinear())
    ...
    function introAnimation(){
        ...
        .fromTo(position, {x: isMobile ? 3 : 1, y: isMobile ? -0.8 : -0.8, z: isMobile ? 1.2 : 0}, {x: isMobile ? 1.28 : 1.28, y: isMobile ? -1.7 : -1.7, z: isMobile ? 5.86 : 5.86, duration: 4, onUpdate}, '-=0.8')
        .fromTo(target, {x: isMobile ? 2.5 : 0, y: isMobile ? -0.07 : 0.12, z: isMobile ? -0.1 : -0.1}, {x: isMobile ? -0.21 : 0.91, y: isMobile ? 0.03 : 0.03, z: isMobile ? -0.25 : -0.25, duration: 4, onUpdate}, '-=4')
        ...
        .fromTo('.hero--container', {opacity: 0, y: '100%'}, {opacity: 1, y: '0%', ease: "power4.inOut", duration: 1.8, onComplete: setupScrollAnimation}, '-=1')
    ...
    function setupScrollAnimation(){
        ...
        .to(ring.rotation,{x: (ringModel == 1) ? 0 :0.92 , y:(ringModel == 1) ? 0 : 0.92, z: (ringModel == 1) ? -Math.PI /2 + 0.65 : Math.PI/3,
            scrollTrigger: { trigger: ".cam-view-3",  start: "top bottom", end: "top top", scrub: true, immediateRender: false }
        })
    ...
    function toggleNightMode(){
        if(!nightMode){
            ...
            viewer.setBackground(new Color('#000136').convertSRGBToLinear())
            nightMode = true
        } else{
